    ...
    <nav className="fixed top-0 left-0 right-0 z-40 h-16 flex items-center pointer-events-none">
      <div className="max-w-[1200px] w-full mx-auto px-6">
        <div className="pointer-events-auto bg-[#0f0f0f] rounded-xl shadow-lg h-12 flex items-center px-2 relative">
          ...
          {/* Logo */}
          <Link href="/admin/dashboard" className="shrink-0 px-3 py-2 flex items-center gap-2">
            <Image
            ...
            />
            <span className="hidden sm:flex items-center gap-1 font-headline text-[10px] font-bold uppercase tracking-widest text-white/30 border border-white/15 rounded px-1.5 py-0.5 ml-1">
          ...
          <div ref={menuRef} className="ml-auto relative shrink-0">
            ...
            {open && (
              <div className="absolute right-0 top-[calc(100%+8px)] w-56 bg-[#0f0f0f] border border-white/10 rounded-xl shadow-2xl overflow-hidden">
