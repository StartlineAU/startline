...
export default function OrganiserTopBar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-14 bg-dark-darker/80 backdrop-blur-xl border-b border-primary/10">
      <div className="flex items-center justify-between h-full max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <div ref={menuRef} className="relative hidden lg:block">
            ...
            {open && (
              <div className="absolute right-0 top-full mt-1 w-52 bg-dark-darker/95 backdrop-blur-xl border border-white/[0.05] rounded-xl shadow-2xl overflow-hidden">
                <div className="px-4 py-3 border-b border-white/10">
