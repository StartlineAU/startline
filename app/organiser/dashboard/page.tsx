...
function StatCard({
  ...
  return (
    <Card className="hover:border-dark-lighter/80 transition-colors stagger-item" style={{ animationDelay: `${delay}ms` }}>
      <CardContent className="p-4 sm:p-6">
        <div className="font-headline text-[10px] uppercase tracking-widest text-muted-dark mb-1.5">{label}</div>
          ...
          <section className="stagger-item" style={{ animationDelay: "160ms" }}>
            ...
            <Card>
              ...
              {!loading && recent.map((e, i) => {
                ...
                return (
                  <div key={e.id} className={i < recent.length - 1 ? "border-b border-dark-lighter" : ""}>
