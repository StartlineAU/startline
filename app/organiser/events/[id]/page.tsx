        ...
        <div className="max-w-[900px] mx-auto px-6 py-8 pb-24 lg:pb-12 page-in">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start gap-6 mb-8">
              ...
              <div className="w-full lg:w-44 h-28 rounded-xl overflow-hidden shrink-0">
                <img src={ef.coverImageUrl(event)!} alt={ef.title(event)} className="w-full h-full object-cover brightness-[.62] saturate-110" />
              </div>
            )}
            ...
            <div className="flex-1">
              ...
              {isRejected && ef.rejectionReason(event) && (
                <div className="mt-3 pl-3 border-l-2 border-red-400/50">
                  ...
                  <p className="text-[13px] text-muted-light leading-relaxed">{ef.rejectionReason(event)}</p>
                </div>
              )}
              {submitErr && (
