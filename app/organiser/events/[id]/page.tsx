      ...
      <div className="min-h-screen bg-dark">
        ...
        <main className="pt-24">
          <div className="max-w-[900px] mx-auto px-6 py-16 text-center">
            ...
            <div className="font-headline text-sm font-bold uppercase tracking-widest text-white/50 mb-5">
              {error || "Event not found."}
            </div>
            <Link href="/organiser/listings" className="font-headline text-[12px] font-bold uppercase tracking-widest text-white/50 hover:text-light transition-colors">
              ← Back to listings
            </Link>
          </div>
        </main>
    ...
    <div className="min-h-screen bg-dark">
      ...
      <main className="pt-24">
        <div className="max-w-[900px] mx-auto px-6 py-8 pb-24 lg:pb-12 page-in">
          ...
          {/* ── Breadcrumb ── */}
          <div className="flex items-center gap-2 font-headline text-[11px] uppercase tracking-widest text-white/40 mb-8">
            <Link href="/organiser/listings" className="hover:text-white/70 transition-colors flex items-center gap-1.5">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start gap-6 mb-8">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="font-headline text-[32px] lg:text-[40px] font-black italic tracking-tighter leading-tight text-light mb-3">
                {event.title}
              </h1>
            ...
            <div className="flex items-center gap-3 shrink-0">
              {isDraft && (
                <button
                  ...
                  disabled={submitting}
                  className="inline-flex items-center gap-2 bg-dark-darker text-white font-headline text-[11px] font-bold uppercase tracking-widest px-4 py-2.5 rounded-lg hover:bg-dark-light transition-colors disabled:opacity-50"
                >
              ...
              {isRejected && (
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-dark-darker text-white font-headline text-[11px] font-bold uppercase tracking-widest px-4 py-2.5 rounded-lg hover:bg-dark-light transition-colors"
                >
              ...
              {!isRejected && (
                <Link
                  href={`/organiser/new-listing?id=${event.id}`}
                  className="inline-flex items-center gap-2 border border-white/[0.08] bg-dark text-white/70 font-headline text-[11px] font-bold uppercase tracking-widest px-4 py-2.5 rounded-lg hover:border-white/[0.08] hover:shadow-sm transition-all"
                >
          ...
          <div className="flex items-start gap-3 py-4 border-b border-white/[0.08] mb-8">
            <div className="flex-1">
              ...
              {isRejected && event.rejectionReason && (
                <div className="mt-3 pl-3 border-l-2 border-red-300">
                  ...
                  <p className="text-[13px] text-white/60 leading-relaxed">{event.rejectionReason}</p>
                </div>
              )}
              {submitErr && (
          ...
          {/* ── Event summary ── */}
          <div>
            <h2 className="font-headline text-xl font-black italic tracking-tighter text-light mb-5">
              Event summary
            </h2>

            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                <div className="font-headline text-[10px] uppercase tracking-widest text-white/40 mb-1">Discipline</div>
                <div className="font-headline text-[13px] font-bold text-light capitalize">
                  {event.discipline.replace(/_/g, " ")}
                </div>
              </div>
              <div>
                <div className="font-headline text-[10px] uppercase tracking-widest text-white/40 mb-1">Capacity</div>
                <div className="font-headline text-[13px] font-bold text-light">
                  {event.cap ? event.cap.toLocaleString() : "Unlimited"}
                </div>
              </div>
              <div>
                <div className="font-headline text-[10px] uppercase tracking-widest text-white/40 mb-1">Ticket tiers</div>
                <div className="font-headline text-[13px] font-bold text-light">
                  {event.waves.length > 0 ? `${event.waves.length} tier${event.waves.length !== 1 ? "s" : ""}` : "None set"}
                </div>
              </div>
              <div>
                <div className="font-headline text-[10px] uppercase tracking-widest text-white/40 mb-1">From</div>
                <div className="font-headline text-[13px] font-bold text-light">
