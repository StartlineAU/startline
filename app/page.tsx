  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[560px] flex items-end overflow-hidden">
        <HeroCarousel />
        {/* Fade hero into white page body */}
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white to-transparent z-10 pointer-events-none" />
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 pt-48 pb-16">
          <p className="font-headline text-xs font-black uppercase tracking-widest text-lime-400 mb-4">
            Australia&apos;s Fitness Event Calendar
          </p>
          <h1 className="font-headline text-6xl sm:text-7xl lg:text-8xl font-black italic leading-none tracking-tighter mb-4 text-white">
            Find Your <span className="text-lime-400">Start Line.</span>
          </h1>
          <p className="font-headline text-base font-medium text-white/70 max-w-2xl leading-relaxed mb-0">
              ...
              >
                <div className="relative w-full aspect-[4/3] overflow-hidden bg-dark mb-3 rounded-3xl">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="font-headline text-[10px] font-bold uppercase tracking-widest bg-primary text-gray-900 px-2 py-1 rounded-full">
                      {EVENT_TYPE_LABELS[event.type]}
                    </span>
                  </div>
                  {event.isOfficial && (
                    <div className="absolute top-3 right-3">
                      <span className="font-headline text-[10px] font-bold uppercase tracking-widest border border-primary/60 text-primary px-2 py-1 bg-black/60 backdrop-blur-sm rounded-full">
                        Official
                      </span>
                    </div>
                  )}
                    ...
                    <div className="relative w-full aspect-[4/3] overflow-hidden bg-dark mb-3 rounded-3xl">
                      ...
                      {event.isOfficial && (
                        <div className="absolute top-2 left-2">
                          <span className="font-headline text-[9px] font-bold uppercase tracking-widest bg-primary text-gray-900 px-1.5 py-0.5 rounded-full">
                            Official
                          </span>
                        </div>
                      )}
