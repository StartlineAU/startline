...
async function main() {
  ...
  const event1 = await prisma.event.upsert({
    ...
    create: {
      ...
      extras: "Spectator tickets $15/day. Parking $12/day.",
      ...
      bagDrop: "Bag drop at Gate 3 from 6:45am.",
      parking: "MSAC car park $12/day.",
  ...
  const event2 = await prisma.event.upsert({
    ...
    create: {
      ...
      cap: 150,
      minAge: 16,
      waves: [{ label: "General Entry", date: "2026-07-01", price: "75", qty: 150 }],
  ...
  const event4 = await prisma.event.upsert({
    ...
    create: {
      ...
      feeStructure: "athlete",
      refundPolicy: "Firm",
      rejectionReason: "Event date has already passed.",
      reviewedAt: new Date("2026-04-01T09:00:00Z"),
    },
  });

  console.log("  Events: 4 created (1 approved, 1 pending, 1 draft, 1 rejected)");
